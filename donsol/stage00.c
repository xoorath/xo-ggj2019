...
static Vtx shade_vtx[] =  {
        {VTX_POS(-64,  64, -5), 0, VTX_UV(0,    4096),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) },
        {VTX_POS( 64,  64, -5), 0, VTX_UV(4096, 4096),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) },
        {VTX_POS( 64, -64, -5), 0, VTX_UV(4096, 0   ),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) },

        {VTX_POS( 64, -65, -5), 0, VTX_UV(4096, 0   ),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) },
        {VTX_POS(-64, -65, -5), 0, VTX_UV(0,    0   ),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) },
        {VTX_POS(-64,  63, -5), 0, VTX_UV(0,    4096),   VTX_RGBA(0xff, 0xff, 0xff, 0xff) }
};
#undef VTX_POS
#undef VTX_UV
#undef VTX_RGBA

static u16 squareIndicies[] = {0,1,2, 3,4,5};
...
void DrawTexture() {
  ...
  gDPLoadTextureBlock(GFX(), &MovieBuf[4], G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 64, 0,
