...
#ifndef _cardclubs2_H_
#define _cardclubs2_H_
...
ImgSeg_t cardclubs2_components[] = {
  {
    _cardclubs2SegmentRomStart + 0,
    _cardclubs2SegmentRomStart + 4096,
    64, 32,
  ...
  {
    _cardclubs2SegmentRomStart + 4096,
    _cardclubs2SegmentRomStart + 8192,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs2_mesh_1
  ...
  {
    _cardclubs2SegmentRomStart + 8192,
    _cardclubs2SegmentRomStart + 11136,
    64, 23,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs2_mesh_2
  }
}; // cardclubs2_components

Img_t cardclubs2 = {
  sizeof(cardclubs2_components)/sizeof(cardclubs2_components[0]),
  cardclubs2_components,
  64, 87,
