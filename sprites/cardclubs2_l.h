...
#ifndef _cardclubs2_l_H_
#define _cardclubs2_l_H_
...
xo_spec_DeclareRomSegment(cardclubs2_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubs2_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubs2_l_mesh_0[] = {
...
ImgSeg_t cardclubs2_l_components[] = {
  {
    _cardclubs2_lSegmentRomStart + 0,
    _cardclubs2_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs2_l_mesh_0
  }
}; // cardclubs2_l_components

Img_t cardclubs2_l = {
  sizeof(cardclubs2_l_components)/sizeof(cardclubs2_l_components[0]),
  cardclubs2_l_components,
  64, 32,
