...
#ifndef _cardclubs3_l_H_
#define _cardclubs3_l_H_
...
xo_spec_DeclareRomSegment(cardclubs3_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubs3_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubs3_l_mesh_0[] = {
...
ImgSeg_t cardclubs3_l_components[] = {
  {
    _cardclubs3_lSegmentRomStart + 0,
    _cardclubs3_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs3_l_mesh_0
  }
}; // cardclubs3_l_components

Img_t cardclubs3_l = {
  sizeof(cardclubs3_l_components)/sizeof(cardclubs3_l_components[0]),
  cardclubs3_l_components,
  64, 32,
