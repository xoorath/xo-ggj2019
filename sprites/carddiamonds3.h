...
#ifndef _carddiamonds3_H_
#define _carddiamonds3_H_
...
xo_spec_DeclareRomSegment(carddiamonds3)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t carddiamonds3;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx carddiamonds3_mesh_0[] = {
...
}; // carddiamonds3_mesh_0

Vtx carddiamonds3_mesh_1[] = {
...
}; // carddiamonds3_mesh_1

Vtx carddiamonds3_mesh_2[] = {
...
}; // carddiamonds3_mesh_2

ImgSeg_t carddiamonds3_components[] = {
  {
    _carddiamonds3SegmentRomStart + 0,
    _carddiamonds3SegmentRomStart + 4096,
    64, 32,
  ...
  {
    _carddiamonds3SegmentRomStart + 4096,
    _carddiamonds3SegmentRomStart + 8192,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    carddiamonds3_mesh_1
  ...
  {
    _carddiamonds3SegmentRomStart + 8192,
    _carddiamonds3SegmentRomStart + 11136,
    64, 23,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    carddiamonds3_mesh_2
  }
}; // carddiamonds3_components

Img_t carddiamonds3 = {
  sizeof(carddiamonds3_components)/sizeof(carddiamonds3_components[0]),
  carddiamonds3_components,
  64, 87,
