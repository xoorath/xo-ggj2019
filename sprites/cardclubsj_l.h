...
#ifndef _cardclubsj_l_H_
#define _cardclubsj_l_H_
...
xo_spec_DeclareRomSegment(cardclubsj_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubsj_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubsj_l_mesh_0[] = {
...
ImgSeg_t cardclubsj_l_components[] = {
  {
    _cardclubsj_lSegmentRomStart + 0,
    _cardclubsj_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubsj_l_mesh_0
  }
}; // cardclubsj_l_components

Img_t cardclubsj_l = {
  sizeof(cardclubsj_l_components)/sizeof(cardclubsj_l_components[0]),
  cardclubsj_l_components,
  64, 32,
