...
#ifndef _cardclubs5_l_H_
#define _cardclubs5_l_H_
...
xo_spec_DeclareRomSegment(cardclubs5_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubs5_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubs5_l_mesh_0[] = {
...
ImgSeg_t cardclubs5_l_components[] = {
  {
    _cardclubs5_lSegmentRomStart + 0,
    _cardclubs5_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs5_l_mesh_0
  }
}; // cardclubs5_l_components

Img_t cardclubs5_l = {
  sizeof(cardclubs5_l_components)/sizeof(cardclubs5_l_components[0]),
  cardclubs5_l_components,
  64, 32,
