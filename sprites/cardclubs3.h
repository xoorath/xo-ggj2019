...
xo_spec_DeclareRomSegment(cardclubs3)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubs3;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubs3_mesh_0[] = {
...
ImgSeg_t cardclubs3_components[] = {
  {
    _cardclubs3SegmentRomStart + 0,
    _cardclubs3SegmentRomStart + 4096,
    64, 32,
  ...
  {
    _cardclubs3SegmentRomStart + 4096,
    _cardclubs3SegmentRomStart + 8192,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs3_mesh_1
  ...
  {
    _cardclubs3SegmentRomStart + 8192,
    _cardclubs3SegmentRomStart + 11136,
    64, 23,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs3_mesh_2
  }
}; // cardclubs3_components

Img_t cardclubs3 = {
  sizeof(cardclubs3_components)/sizeof(cardclubs3_components[0]),
  cardclubs3_components,
  64, 87,
