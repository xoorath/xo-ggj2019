...
#ifndef _cardclubs4_l_H_
#define _cardclubs4_l_H_
...
xo_spec_DeclareRomSegment(cardclubs4_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardclubs4_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardclubs4_l_mesh_0[] = {
...
ImgSeg_t cardclubs4_l_components[] = {
  {
    _cardclubs4_lSegmentRomStart + 0,
    _cardclubs4_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardclubs4_l_mesh_0
  }
}; // cardclubs4_l_components

Img_t cardclubs4_l = {
  sizeof(cardclubs4_l_components)/sizeof(cardclubs4_l_components[0]),
  cardclubs4_l_components,
  64, 32,
