...
#ifndef _cardjoker_l_H_
#define _cardjoker_l_H_
...
xo_spec_DeclareRomSegment(cardjoker_l)

#ifndef GENERATED_IMAGE_DECLARATIONS
extern Img_t cardjoker_l;
#else // GENERATED_IMAGE_DECLARATIONS
#include <xo-render.h>
#include <PR/gbi.h>

Vtx cardjoker_l_mesh_0[] = {
...
ImgSeg_t cardjoker_l_components[] = {
  {
    _cardjoker_lSegmentRomStart + 0,
    _cardjoker_lSegmentRomStart + 4096,
    64, 32,
    G_TX_CLAMP | G_TX_NOMIRROR, G_TX_CLAMP | G_TX_NOMIRROR,
    NULL,
    cardjoker_l_mesh_0
  }
}; // cardjoker_l_components

Img_t cardjoker_l = {
  sizeof(cardjoker_l_components)/sizeof(cardjoker_l_components[0]),
  cardjoker_l_components,
  64, 32,
